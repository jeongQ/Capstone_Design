#include <jni.h>
#include "com_example_shinseungchan_ssd_views_CameraActivity.h"
...
extern "C" {
    ...
    JNIEXPORT jlong JNICALL Java_com_example_shinseungchan_ssd_controller_CameraActivity_loadCascade (JNIEnv *env, jobject type, jstring cascadeFileName_) {
    ...
    JNIEXPORT jint JNICALL Java_com_example_shinseungchan_ssd_controller_CameraActivity_detect
